  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (validateForm(currentStep)) {
      ...
      try {
          ...
          for (const key in data) {
            if (Object.prototype.hasOwnProperty.call(data, key)) {
              ...
              if (Array.isArray(value)) {
                // Handle array values by joining them with a separator
                params.append(key, value.join(", "));
              } else if (value !== undefined) {
                // Append other values, converting booleans to string
        ...
        // Example usage in your fetch request
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                {currentStep === 2 && (
                  <div className="px-4 py-6 bg-gray-50 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-600 mb-6 text-center">
                      Tell us more about your relevant experience for your
                      chosen team.
                    </p>
                    ...
                    <div className="mb-7">
                      <label
                        ...
                        className="block text-teal-900 font-medium mb-2"
                      >
                        Years of professional or significant volunteer
                      ...
                      <>
                        ...
                        <div className="mb-7">
                          <label
                            ...
                            className="block text-teal-900 font-medium mb-2"
                          >
                            Please provide your GitHub profile or relevant
                            project links.{" "}
                            <span className="text-red-500">*</span>
                          </label>
                          <input
                    ...
                    {formData.primaryInterest === "Other" && (
                      <div className="mb-7">
                        <label
                          ...
                          className="block text-teal-900 font-medium mb-2"
                        >
                          Please specify your other skills and how they relate
                          to Baytul-Sakinah.{" "}
                          <span className="text-red-500">*</span>
                        </label>
                        <textarea
